...
1.0.0-alpha18). This renderer decodes 128 of them; this file says what each one does here.
...
`DATA_SOUND`, `SOUND_EXPRESSION`), the loom macro system (`MACRO_*`, `REFERENCED_OPERATIONS`,
