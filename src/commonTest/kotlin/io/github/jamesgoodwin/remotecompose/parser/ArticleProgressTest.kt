...
class ArticleProgressTest {
    ...
    fun theBarIsDrivenByTheSameFloatTheScrollWrites() {
        ...
        val positionId = io.github.jamesgoodwin.remotecompose.runtime.FloatExpressionEvaluator
        ...
        assertTrue(
            expressions.any { expression ->
                expression.expression.any {
                    io.github.jamesgoodwin.remotecompose.runtime.FloatExpressionEvaluator.isVariable(it) &&
                        io.github.jamesgoodwin.remotecompose.runtime.FloatExpressionEvaluator.idOf(it) == positionId
                }
            },
