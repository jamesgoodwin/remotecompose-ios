 ...
 * `then(RippleModifier())` modifier, and a magenta rect carrying a `drawContent()` modifier), not
 * by anything in this codebase. Shared by every platform demo entry point (iOS, Android) so they
...
val SAMPLE_RC_BYTES: ByteArray by lazy {
    Base64.decode(
        "AAAAAAEAAAABAAAAAAAAAMgAAADIAAAAAAAAAABmAAAAKgAAAARkZW1vZwAAACooAAAAAgAAAAT/5Tk1KkGgAABBoAAAQzQAAEM0AAAoAAAA" +
            ...
            "///TKAAAAAIAAAAE/60UVypDJAAAQXAAAEMzAABByAAA1tY="
    )
}
