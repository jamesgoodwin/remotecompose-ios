 ...
 * `drawOval`, a cyan `drawArc`, a pink `drawSector`, and an indigo `drawPath` triangle), not by
 * anything in this codebase. Shared by every platform demo entry point (iOS, Android) so they
 * render byte-identical input — the point of the cross-platform comparison is to catch
