...
import io.github.jamesgoodwin.remotecompose.text.BitmapGlyph
...
internal object OperationReader {
    ...
    private fun readOne(r: BufferReader): Op = when (val opId = r.readU8()) {
        ...
        Operations.RUN_ACTION -> Op.RunAction
        Operations.WAKE_IN -> Op.WakeIn(r.readFloat32())
        ...
        Operations.COLOR_THEME -> Op.ColorTheme(
            ...
            lightMode = r.readS32(), darkMode = r.readS32(),
        )
