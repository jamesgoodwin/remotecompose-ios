...
The demo app carries a page per document in `tools/rc-writer/`. Every one is generated by the
official Android writer rather than by hand — see "Fixtures" below.
...
# ios: open iosApp/RemoteComposeDemo.xcodeproj, or
